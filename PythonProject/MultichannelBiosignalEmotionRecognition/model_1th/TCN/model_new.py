...
if __name__ == "__main__":
    ...
    train_index = permutation[:23]
    test_index = permutation[23:]
    # 获取生理信号数据
    datas_train, train_labels = read_data(people_list=train_index, windows=4, overlapping=3, raw_data=True)
    datas_test, test_labels = read_data(people_list=test_index, windows=4, overlapping=3, raw_data=True)
