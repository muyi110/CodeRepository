...
if __name__ == "__main__":
    ...
    train_trial_list = list(range(0, 36))
    test_trial_list = list(range(36, 40))
    # 获取生理信号数据
    ...
    rnn = RNNClassifier(random_state=42, learning_rate=1e-4, dropout=0.0)
    rnn.fit(X=datas_train, y=train_labels, n_epochs=50, X_test=datas_test, y_test=test_labels, multi_cell_cell=False)
